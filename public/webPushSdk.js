...
(() => {
  ...
  // src/sdk/webPushSdk.js
  var WebPushSdk = class {
    constructor(config) {
      var _a, _b;
      this.config = config;
      this.app = null;
      ...
      this.log("constructor", "SDK initialized", {
        serviceWorkerPath: (_a = config.serviceWorkerPath) != null ? _a : "/firebase-messaging-sw.js",
        serviceWorkerScope: (_b = config.serviceWorkerScope) != null ? _b : null
      });
    }
    ...
    async registerServiceWorker() {
      ...
      const registration = await navigator.serviceWorker.register(
        (_a = this.config.serviceWorkerPath) != null ? _a : "/firebase-messaging-sw.js",
        {
    ...
    async getMessagingClient() {
      ...
      this.messaging = getMessagingInWindow(this.ensureFirebaseApp());
    ...
    async getWebPushToken(options = {}) {
      ...
      const shouldRequestPermission = (_a = options.requestPermission) != null ? _a : true;
      ...
      const token = await getToken2(messagingClient, {
        vapidKey: this.config.vapidKey,
        serviceWorkerRegistration: registration != null ? registration : void 0
      });
    ...
    async insertFcmToken(options) {
      const { token, browser: browser2, domainId, customer, insertFcm } = options;
      this.log("insertFcmToken", "Posting token to API", {
        endpoint: insertFcm.endpoint,
        domainId,
        browser: browser2 || this.getBrowserName()
      });
      const headers = {
        "Content-Type": "application/json",
        ...insertFcm.headers || {}
    ...
    async subscribeWithLoginStyleConfig(options) {
      ...
      const endpoint = options.baseUrl ? `${baseUrl}${insertPath.startsWith("/") ? insertPath : `/${insertPath}`}` : insertPath;
    ...
    async persistWebPushToken(options) {
      ...
      if (insertTokenToDb) {
        ...
        await insertTokenToDb({ token, browser: browser2 });
      }
      if (setIndexDbValue) {
  ...
  var campaignWebPushSdk = new WebPushSdk({
  ...
  if (typeof window !== "undefined") {
    ...
    window.WorktualWebPushSDK = {
      ...
      subscribeWithCampaignDefaults: (options) => campaignWebPushSdk.subscribeWithLoginStyleConfig(options)
    };
  }
})();
...
@firebase/messaging/dist/esm/index.esm.js:
   ...
   *)
*/
//# sourceMappingURL=webpush-sdk.bundle.js.map

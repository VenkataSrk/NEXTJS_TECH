...
#define MNTRSERVICE MonitorService::instance()
class xGateMonitorService : public ACE_Task<ACE_MT_SYNCH>, public IURModule
{
    public:
        xGateMonitorService();
        ~xGateMonitorService();
...
typedef ACE_Unmanaged_Singleton<xGateMonitorService, ACE_Recursive_Thread_Mutex> MonitorService;
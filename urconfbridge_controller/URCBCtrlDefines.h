...
#define URCONF_ACTIVE_SPEAKER_INFO_TIMER_VAL 3
...
typedef enum URConfSIOMsgType
{
  ...
  URCONF_SIO_MSG_ACTIVE_SPEAKER_INFO = 22,
	URCONF_SIO_MSG_INITIAL_SPEAKER_INFO = 23,
  URCONF_SIO_MSG_GRID_VIEW_VIDEO_REQUEST = 24,
  URCONF_SIO_MSG_CUSTOMER_JOINING = 25,
  URCONF_SIO_MSG_CUSTOMER_JOINED = 26,
  URCONF_SIO_MSG_AGENT_JOINING = 27,
  URCONF_SIO_MSG_AGENT_JOINED = 28,
}URConfSIOMsgType;
...
struct UserData {
  ...
  std::deque<VolumeUpdate> volumeUpdates;
};
...
struct URActiveSpeakerInfo
{
   ...
   string m_strCallId;
   string m_strConnId;	
	 string m_strPrevSpkrCallId;
	 string m_strPrevSpkrConnId;
};
...
class URCONF_USER_INFO
{
   public:
      ...
      URCONF_USER_INFO(const URCONF_USER_INFO& tRobj)
      {
         ...
         m_strPrevSpkrConnId = tRobj.m_strPrevSpkrConnId.c_str();
      ...
      std::string m_strPrevSpkrConnId;

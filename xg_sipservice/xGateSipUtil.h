...
typedef enum XGATESIPEVENT{
    ...
    EN_MAKE_CALL_FAILED_RES,//added to intimate dialout failed to controller when 4xx/5xx error resp recvd
    EN_SDP_UPDATE_REL,//added to intimate change in SDP of conf user for the sessions established for that user
    EN_REDIRECT_REQUEST_EVENT_REL,//added to redirect conf calls to same conf bridge based on room id
    EN_100_REL=100,
    EN_180_REL=180,
    EN_181_REL,
    EN_182_REL,

...
#if 0
   if ( e->e_status == 404 ) {
        e->e_phrase = strcpy(e->e_phrase,"Busy Here");
        e->e_status = 486;
    }
#endif
				 ...
				 nua_event_t special)
{
  ...
  {
    printf("\n NUA_STACK_SET_HANDLE_SPECIAL : kind, %d special %d nh_special %d return -1 \n",
	kind,special,nh->nh_special);
    return -1;
  }

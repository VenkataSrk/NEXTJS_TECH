...
/* Define to 1 if we use GCC 4.8 Supportlibrary */
/* #undef HAVE_GCC_4_8_HIGH */

/* Define to 1 if we use Gmutex */
#define HAVE_GMUTEX 1

/* Define to 1 if we use OpenSSL Update */
//#define HAVE_V_OPENSSL 1
#define HAVE_V_OPENSSL 0

...
/**Return true if @a string is valid IP6 address if host_is_ip6_address failed
 *
 * E.g., 2409:4072:6e96:fad5:28bf:a034:59c4:6e84 is a valid IP6  public address
 */

int recheck_host_is_ip6_address(char const *string)
{

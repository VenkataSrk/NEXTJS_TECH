...
const OperationHubWebPushConfig = () => {
  ...
  const webpushRefresh = useSelector((state :any)=>state.commonData.webpushRefresh);
 ...
 const fileInputRef = useRef(null);
  ...
  const handleRemoveImage = (e:any) => {
    ...
    useEffect(()=>{
      if(webpushRefresh){
        getWebPushConfig();
        dispatch(commonDataSliceActions.setWebPushRefresh(false))
      }
    },[webpushRefresh])
            ...
            <form className='formsec'>
                ...
                <div className='formrow'>
                    {websiteData?.length>0 &&
                          ...
                          {websiteData?.length==-1 && <div className='formelements'>
                    ...
                    {/* {websiteData?.length==0 &&
                     ...
                     (<> <button className='cancelbtn'>Cancel</button><button  type="button" className='primarybtn' onClick={(e :any)=>handleSubmit(e)}>Save</button></>)}  */}
                ...
                <div style={{ display: "grid", placeItems: "center", height: "calc(100% - 132px)" }}>
                                                <div className='pannelcenter'>
                                                    <div className='imgcon'>
                                                        <img src={assets.apppushconfigicon}></img>
                                                    </div>
                                                    <div className='info'>

                                                        <h5>Configure Webpush Channel</h5>
                                                        <p>You need to configure Web Push to start sending push notifications to your users</p>
...
export default OperationHubWebPushConfig

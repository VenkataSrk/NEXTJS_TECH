...
function  OperationHubApppush() {
    ...
    const apppushRefresh =useSelector((state :any)=>state.commonData.appPushRefresh);
    ...
    useEffect(()=>{
        if(apppushRefresh){
            const init=()=>{
                fetchEncryptionKeys();
                fetchAppMainConfig();
                dispatch(commonDataSliceActions.setAppPushRefresh(false));
            }
            init();
        }
    },[apppushRefresh])
                        ...
                        <div style={{padding:"0 16px"}} className={styles.tophdlefts}>
                          ...
                          <div className='formsec '>
                              <div className='formrow'>
                                 <div className='formlabels'>
                                  ...
                                  <div className='formelements'>
                                      <input type="text" name="type" id="domainname" onChange={(e: any) => { handleMainConfig(e) }} value={mainConfig?.type} placeholder='worktual_c2768' readOnly  />
                                  </div>
                               ...
                               <div className='formrow'>
                                 <div className='formlabels'>
                                  ...
                                  <div className='formelements'>
                                      <input type="text" name="projectId" id="domainname" onChange={(e: any) => { handleMainConfig(e) }} value={mainConfig?.projectId} placeholder='worktual_c2768' readOnly />
                                  </div>
                              ...
                              <div className='formrow'>
                                  ...
                                  <div className='formelements'>
                                      <input type="text" name="privateKeyId" id="domainname" onChange={(e: any) => { handleMainConfig(e) }} value={mainConfig?.privateKeyId} placeholder='worktual_c2768' readOnly />
                                  </div>
                                  ...
                                  <div className='formelements'>
                                      <input type="text" name="privateKey" id="domainname" onChange={(e: any) => { handleMainConfig(e) }} value={mainConfig?.privateKey} placeholder='worktual_c2768' readOnly />
                                  </div>
                                  ...
                                  <div className='formelements'>
                                      <input type="text" name="clientEmail" id="domainname" onChange={(e: any) => { handleMainConfig(e) }} value={mainConfig?.clientEmail} placeholder='worktual_c2768' readOnly />
                                  </div>
                                  ...
                                  <div className='formelements'>
                                      <input type="text" name="clientId" id="domainname" onChange={(e: any) => { handleMainConfig(e) }} value={mainConfig?.clientId} placeholder='worktual_c2768' readOnly />
                                  </div>
                                  ...
                                  <div className='formelements'>
                                      <input type="text" name="authUrl" id="domainname" onChange={(e: any) => { handleMainConfig(e) }} value={mainConfig?.authUrl} placeholder='worktual_c2768' readOnly />
                                  </div>
                                  ...
                                  <div className='formelements'>
                                      <input type="text" name="tokenUrl" id="domainname" onChange={(e: any) => { handleMainConfig(e) }} value={mainConfig?.tokenUrl} placeholder='worktual_c2768' readOnly />
                                  </div>
                              ...
                              <div className='formrow'>
                                  ...
                                  <div className='formelements'>
                                      <input type="text" name="authProviderUrl" id="domainname" onChange={(e: any) => { handleMainConfig(e) }} value={mainConfig?.authProviderUrl} placeholder='worktual_c2768' readOnly />
                                  </div>
                              ...
                              <div className='formrow'>
                                  ...
                                  <div className='formelements'>
                                      <input type="text" name="clientUrl" id="domainname" onChange={(e: any) => { handleMainConfig(e) }} value={mainConfig?.clientUrl} placeholder='worktual_c2768' readOnly />
                                  </div>
                              ...
                              <div className='formrow'>
                                  ...
                                  <div className='formelements'>
                                      <input type="text" name="universeDomain" id="domainname" onChange={(e: any) => { handleMainConfig(e) }} value={mainConfig?.universeDomain} placeholder='worktual_c2768' readOnly />
                                  </div>
...
{/* sample form input */}
              {/* <div className='formrow'>
                  ...
                  <div className='formelements'>
                      <input type="text" name="" id="domainname" placeholder='worktual_c2768' readOnly />
                  </div>
              </div> */}
              <div className='formrow'>
                  <div className='formlabels'>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "12px" }} className='formelements'>
                      ...
                      <span  style={{display: "flex", alignItems: "center", gap: "8px" , fontSize:"13px",cursor: 'pointer' }} onClick={()=> {navigator.clipboard.writeText(encrypt?.appId); setCopied({...copied,appCopy:true}); setTimeout(()=>setCopied({...initialCopied}),3000)} }>
               ...
               <div className='formrow'>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "12px" }} className='formelements'>
                    ...
                    <span  style={{display: "flex", alignItems: "center", gap: "8px" , fontSize:"13px",cursor: 'pointer' }} onClick={() => { navigator.clipboard.writeText(encrypt?.secretKey); setCopied({ ...copied, secretCopy: true }); setTimeout(() => setCopied({ ...initialCopied }), 3000) }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                            <path d="M16.6887 1.47334C15.5505 0.39324 13.9787 0.210641 12.4509 0.174541C11.2068 0.142341 10.3259 0.142341 9.08575 0.174541C7.55695 0.210641 5.98515 0.39234 4.84695 1.47334C4.37575 1.92014 4.08805 2.46164 3.90635 3.03044C2.86425 3.22774 2.03965 3.60684 1.41085 4.20374C0.160347 5.39024 0.124747 7.21744 0.0988472 8.55234L0.0959473 11.9644L0.0988472 12.1119C0.124747 13.4459 0.160347 15.273 1.41085 16.4693C2.59835 17.5963 4.24335 17.7867 5.84245 17.8248C6.49625 17.8414 7.05435 17.8492 7.61195 17.8492C8.16955 17.8492 8.72815 17.8414 9.38005 17.8248C10.9806 17.7867 12.6256 17.5963 13.8131 16.4693C14.5191 15.7999 14.8238 14.9312 14.9678 14.1514C15.5975 13.96 16.1865 13.6648 16.6886 13.188C17.8849 12.0542 17.9205 10.3296 17.944 9.17344V5.47324C17.9206 4.33264 17.885 2.60814 16.6887 1.47334ZM16.4316 5.06274C15.6751 5.05424 15.1289 5.02224 14.6984 4.89814C13.4782 4.56124 12.5573 3.43814 12.4587 2.16184C12.4453 2.00024 12.453 1.83834 12.4554 1.67674C13.8542 1.71214 14.9368 1.87794 15.6564 2.56124C16.2572 3.13154 16.3915 4.05804 16.4316 5.06274ZM12.781 15.3815C12.0071 16.1159 10.8479 16.2897 9.34355 16.3249C8.06425 16.3581 7.16235 16.3581 5.87915 16.3249C4.37625 16.2897 3.21705 16.1149 2.44555 15.3835C1.64765 14.6208 1.62185 13.2722 1.59885 12.0837L1.59595 8.73124L1.59885 8.58184C1.62175 7.39334 1.64765 6.04664 2.44305 5.29184C2.75205 4.99884 3.14195 4.78844 3.62465 4.63824C3.60115 4.98764 3.59405 5.32524 3.58805 5.63454L3.58515 8.87964L3.58805 9.02024C3.61245 10.2946 3.64615 12.0407 4.84635 13.1882C5.98455 14.2683 7.55635 14.4509 9.08415 14.487C9.70625 14.5026 10.2369 14.5104 10.7677 14.5104C11.298 14.5104 11.8292 14.5026 12.4493 14.487C12.7487 14.4799 13.0493 14.4641 13.3485 14.4401C13.2154 14.8339 13.0317 15.1437 12.781 15.3815ZM15.6565 12.1003C14.929 12.7907 13.8342 12.9538 12.4128 12.987C11.196 13.0173 10.3396 13.0173 9.12085 12.987C7.70095 12.9538 6.60625 12.7907 5.88115 12.1022C5.13405 11.3874 5.10965 10.1149 5.08765 8.99184L5.08525 5.80634L5.08765 5.66274C5.10965 4.54064 5.13405 3.26824 5.87965 2.56114C6.60625 1.87074 7.70095 1.70764 9.12235 1.67444C9.73075 1.65884 10.2488 1.65104 10.7678 1.65104C10.8201 1.65104 10.8746 1.65204 10.927 1.65224C10.9243 1.86364 10.9164 2.07604 10.9338 2.28384C11.0827 4.21744 12.4323 5.86004 14.2829 6.37074C14.8796 6.54284 15.5442 6.58214 16.444 6.59144V9.15784C16.4201 10.3375 16.3416 11.4509 15.6565 12.1003Z" fill="black" />
                        </svg>
              ...
              <div className='formrow'>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "12px" }} className='formelements'>
                      ...
                      <span  style={{display: "flex", alignItems: "center", gap: "8px" , fontSize:"13px",cursor: 'pointer' }}onClick={()=> {navigator.clipboard.writeText(`${config().BASE_URL}/campaignService/v1/insert_update_tpi_contact`); setCopied({...copied,urlCopy:true}); setTimeout(()=>setCopied({...initialCopied}),3000) } }>
                           <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                          <path d="M16.6887 1.47334C15.5505 0.39324 13.9787 0.210641 12.4509 0.174541C11.2068 0.142341 10.3259 0.142341 9.08575 0.174541C7.55695 0.210641 5.98515 0.39234 4.84695 1.47334C4.37575 1.92014 4.08805 2.46164 3.90635 3.03044C2.86425 3.22774 2.03965 3.60684 1.41085 4.20374C0.160347 5.39024 0.124747 7.21744 0.0988472 8.55234L0.0959473 11.9644L0.0988472 12.1119C0.124747 13.4459 0.160347 15.273 1.41085 16.4693C2.59835 17.5963 4.24335 17.7867 5.84245 17.8248C6.49625 17.8414 7.05435 17.8492 7.61195 17.8492C8.16955 17.8492 8.72815 17.8414 9.38005 17.8248C10.9806 17.7867 12.6256 17.5963 13.8131 16.4693C14.5191 15.7999 14.8238 14.9312 14.9678 14.1514C15.5975 13.96 16.1865 13.6648 16.6886 13.188C17.8849 12.0542 17.9205 10.3296 17.944 9.17344V5.47324C17.9206 4.33264 17.885 2.60814 16.6887 1.47334ZM16.4316 5.06274C15.6751 5.05424 15.1289 5.02224 14.6984 4.89814C13.4782 4.56124 12.5573 3.43814 12.4587 2.16184C12.4453 2.00024 12.453 1.83834 12.4554 1.67674C13.8542 1.71214 14.9368 1.87794 15.6564 2.56124C16.2572 3.13154 16.3915 4.05804 16.4316 5.06274ZM12.781 15.3815C12.0071 16.1159 10.8479 16.2897 9.34355 16.3249C8.06425 16.3581 7.16235 16.3581 5.87915 16.3249C4.37625 16.2897 3.21705 16.1149 2.44555 15.3835C1.64765 14.6208 1.62185 13.2722 1.59885 12.0837L1.59595 8.73124L1.59885 8.58184C1.62175 7.39334 1.64765 6.04664 2.44305 5.29184C2.75205 4.99884 3.14195 4.78844 3.62465 4.63824C3.60115 4.98764 3.59405 5.32524 3.58805 5.63454L3.58515 8.87964L3.58805 9.02024C3.61245 10.2946 3.64615 12.0407 4.84635 13.1882C5.98455 14.2683 7.55635 14.4509 9.08415 14.487C9.70625 14.5026 10.2369 14.5104 10.7677 14.5104C11.298 14.5104 11.8292 14.5026 12.4493 14.487C12.7487 14.4799 13.0493 14.4641 13.3485 14.4401C13.2154 14.8339 13.0317 15.1437 12.781 15.3815ZM15.6565 12.1003C14.929 12.7907 13.8342 12.9538 12.4128 12.987C11.196 13.0173 10.3396 13.0173 9.12085 12.987C7.70095 12.9538 6.60625 12.7907 5.88115 12.1022C5.13405 11.3874 5.10965 10.1149 5.08765 8.99184L5.08525 5.80634L5.08765 5.66274C5.10965 4.54064 5.13405 3.26824 5.87965 2.56114C6.60625 1.87074 7.70095 1.70764 9.12235 1.67444C9.73075 1.65884 10.2488 1.65104 10.7678 1.65104C10.8201 1.65104 10.8746 1.65204 10.927 1.65224C10.9243 1.86364 10.9164 2.07604 10.9338 2.28384C11.0827 4.21744 12.4323 5.86004 14.2829 6.37074C14.8796 6.54284 15.5442 6.58214 16.444 6.59144V9.15784C16.4201 10.3375 16.3416 11.4509 15.6565 12.1003Z" fill="black" />
                            </svg>
                           {copied?.urlCopy && <span style={{fontSize:"13px", fontFamily:"interregular",cursor: 'pointer'}}>Copied</span>}
                      </span>
                  </div>
              </div>
              <div className='formrow'>
    ...
    "contactEmail":"[{\"firstName\":\"Alice\",\"email\":\"alice@example.com\",\"deviceId\":\"device123\",\"deviceOS\":\"Android\",\"pushNotificationId\":\"ekqtD6FTQzqdZNnwoFLmdA:APA91bGHvgwdHhGaq-ikymVeh3DoqJ4IfvEKhT2B6dxcirzg2YF9_JluzV2pInyRjz8TOxjnuGCvuF_t0SdyxO-A4v60bgzVI7yn99v3jpiFvfgC4Ie6b3I\"},{\"firstName\":\"Bob\",\"email\":\"bob@example.com\",\"deviceId\":\"device456\",\"deviceOS\":\"Android\"},{\"firstName\":\"Charlie\",\"email\":\"charlie@example.com\",\"deviceId\":\"device789\",\"deviceOS\":\"\IOS\"}]"
          ...
          <WorktualModal
              show={mainModal}
                 title= {<> Setup App
                        <p style={{fontSize:"14px", fontWeight:"400", paddingTop:"6px"}}>Set up your Application for push notifications.</p></>}
                        footer={<> <div className='formbtns'>
              ...
              <>
                  <div className='formsec '>
                      ...
                      <div className='formrow'>
                          ...
                          <div className='formelements'>
                              <input type="text" name="projectId" id="domainname" onChange={(e :any)=>{handleMainConfig(e)}}  placeholder='worktual_c2768' readOnly />
                          </div>
                          {(validation && !mainConfig?.projectId?.trim()) && <p className='error'>This field is required</p>}
                      </div>
                      <div className='formrow'>
                          ...
                          <div className='formelements'>
                              <input type="text" name="privateKeyId" id="domainname" onChange={(e :any)=>{handleMainConfig(e)}}  placeholder='worktual_c2768' readOnly />
                          </div>
                          {(validation && !mainConfig?.privateKeyId?.trim()) && <p className='error'>This field is required</p>}
                      </div> <div className='formrow'>
                          <div className='formlabels'>
                          ...
                          <div className='formelements'>
                              <input type="text" name="privateKey" id="domainname" onChange={(e :any)=>{handleMainConfig(e)}}  placeholder='worktual_c2768' readOnly />
                          </div>
                          {(validation && !mainConfig?.privateKey?.trim()) && <p className='error'>This field is required</p>}
                      </div> <div className='formrow'>
                          <div className='formlabels'>
                          ...
                          <div className='formelements'>
                              <input type="text" name="clientEmail" id="domainname"  onChange={(e :any)=>{handleMainConfig(e)}}  placeholder='worktual_c2768' readOnly />
                          </div>
                          {(validation && !mainConfig?.clientEmail?.trim()) && <p className='error'>This field is required</p>}
                      </div> <div className='formrow'>
                          <div className='formlabels'>
                          ...
                          <div className='formelements'>
                              <input type="text" name="clientId" id="domainname" onChange={(e :any)=>{handleMainConfig(e)}}  placeholder='worktual_c2768' readOnly />
                          </div>
                          {(validation && !mainConfig?.clientId?.trim()) && <p className='error'>This field is required</p>}
                      </div> <div className='formrow'>
                          <div className='formlabels'>
                          ...
                          <div className='formelements'>
                              <input type="text" name="authUrl" id="domainname" onChange={(e :any)=>{handleMainConfig(e)}}  placeholder='worktual_c2768' readOnly />
                          </div>
                          {(validation && !mainConfig?.authUrl?.trim()) && <p className='error'>This field is required</p>}
                      </div> <div className='formrow'>
                          <div className='formlabels'>
                          ...
                          <div className='formelements'>
                              <input type="text" name="tokenUrl" id="domainname" onChange={(e :any)=>{handleMainConfig(e)}}  placeholder='worktual_c2768' readOnly />
                          </div>
                          {(validation && !mainConfig?.tokenUrl?.trim()) && <p className='error'>This field is required</p>}
                      </div>
                      <div className='formrow'>
                          ...
                          <div className='formelements'>
                              <input type="text" name="authProviderUrl" id="domainname" onChange={(e :any)=>{handleMainConfig(e)}}  placeholder='worktual_c2768' readOnly />
                          </div>
                          {(validation && !mainConfig?.authProviderUrl?.trim()) && <p className='error'>This field is required</p>}
                      </div>
                      <div className='formrow'>
                          ...
                          <div className='formelements'>
                              <input type="text" name="clientUrl" id="domainname" onChange={(e :any)=>{handleMainConfig(e)}}  placeholder='worktual_c2768' readOnly />
                          </div>
                          {(validation && !mainConfig?.clientUrl?.trim()) && <p className='error'>This field is required</p>}
                      </div>
                      <div className='formrow'>
                          ...
                          <div className='formelements'>
                              <input type="text" name="universeDomain" id="domainname"  onChange={(e :any)=>{handleMainConfig(e)}}  placeholder='worktual_c2768' readOnly />
                          </div>
                          {(validation && !mainConfig?.universeDomain?.trim()) && <p className='error'>This field is required</p>}
                      </div>                    
...
export default OperationHubApppush
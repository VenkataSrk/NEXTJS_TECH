...
function OperationSmsconfig() {
    ...
    const smsConfigRefresh =useSelector((state :any)=>state.commonData.smsConfigRefresh);
    ...
    useEffect(()=>{
        if(smsConfigRefresh){
            getSmsList();
            dispatch(commonDataSliceActions.setSmsConfigRefresh(false));
        }
    },[smsConfigRefresh])
...
export default OperationSmsconfig;
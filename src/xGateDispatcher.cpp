  ...
  m_run(false)
{
  ...
  XGLOG_ERROR( "xGateDispatcher::xGateDispatcher(%s)", (char*)ur_log_string (m_serverType));
}
...
{
  XGLOG_ERROR( "xGateDispatcher::stop(%s)", (char*)ur_log_string (m_serverType));
  ...
  XGLOG_ERROR( "xGateDispatcher::stop Stopped xGateDispatcher(%s)", (char*)ur_log_string (m_serverType));
...
{
  XGLOG_ERROR( "xGateDispatcher::init(%s)", (char*)ur_log_string (m_serverType));
  m_run = true;
  ...
  if (activate(THR_NEW_LWP , 1) == -1 )
  {
    ...
    XGLOG_ERROR( "xGateDispatcher::startThread(%s)"\
  ...
  {
    // Successfull start
    XGLOG_ERROR( "xGateDispatcher::init(%s) Success", (char*)ur_log_string (m_serverType));
  }
  return retVal;
}
...
{
  XGLOG_ERROR( "xGateDispatcher::svc(%s)", (char*)ur_log_string (m_serverType));
  ...
  while(m_run)
  {
    ...
    else
    {
      ...
      XGLOG_ERROR( "xGateDispatcher::svc(%s) Error in Message Queue", (char*)ur_log_string (m_serverType));
      m_run = false;
    }
...
{
  XGLOG_ERROR( "xGateDispatcher::dispatchMessage(%s)", (char*)ur_log_string (m_serverType));
  return EN_XGATE_STATUS_SUCCESS;
}

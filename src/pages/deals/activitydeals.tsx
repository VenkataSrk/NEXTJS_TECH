...
const Activitydeals = () => {
    ...
    const { activityTimeLine } = useSelector((state: any) => state.inboxChatStore);

    return (
        <>
            <div className={styles.activitylinelist}>
                <div className={styles.timelineheader}>
                    <svg onClick={() => navigate(-1)} xmlns="http://www.w3.org/2000/svg" width="8" height="16" viewBox="0 0 8 16" fill="none">
                ...
                <div className={styles.activecenter}>

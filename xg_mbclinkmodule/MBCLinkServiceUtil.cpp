...
MBCLinkServiceUtil::MBCLinkServiceUtil()
{
}

MBCLinkServiceUtil::~MBCLinkServiceUtil(void)
{
}

ACE_Thread_Mutex MBCLinkServiceUtil::m_sessionDetailMapLock;
void MBCLinkServiceUtil::addToMgConnectionMap(TcpConTuple& tuple)
{
...
bool MBCLinkServiceUtil::getFromMgConnectionMap(const unsigned short& index, unsigned short& fd)
{
...
int MBCLinkServiceUtil::getFromMgConnectionMap(string& ipaddr)
{
...
bool MBCLinkServiceUtil::getFromMgConnectionMap(string& ip, unsigned short port, int& fd)
{
...
void MBCLinkServiceUtil::removeFromMgConnectionMap(TcpConTuple& tuple)
{
...
bool MBCLinkServiceUtil::isPresentInMgConnectionMap(string& ip, unsigned short port)
{
...
void MBCLinkServiceUtil::getTimerIdFromConnMap(int fd, long int &timerId)
{

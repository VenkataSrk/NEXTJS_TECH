...
typedef enum
{
  ...
  EN_DB_EVENT_STORE_CALL_REC_DATA_QUERY = 1,
  EN_DB_EVENT_STORE_VIDEO_REC_DATA_QUERY = 2,
  EN_DB_EVENT_STORE_CCAAS_VIDEO_REC_DATA_QUERY = 3,
} DBServiceEvent;
...
{
  EN_V_ID = 1,
}VideoRecordFieldIndex;

typedef enum
{
  EN_ERR_CODE = 1,
  EN_ERR_MSG = 2,
}CcaasVideoRecordFieldIndex;
...
public:
  ...
  DBConnectionInfo(const DBConnectionInfo &rhs)
  {
    ...
    m_sDBSrvPort = rhs.m_sDBSrvPort.c_str();

...
xGateRetVal MediaTcpConnector::send_client_connected(unsigned int connectId,int dstModuleId,string Ip,int port)
{
 xGateMediaServiceMsg *pMsg = new xGateMediaServiceMsg();
 xGateNetConnection netConnInfo;
 pMsg->setMsgType((xGateMsgType)EN_XGATE_MSG_CLIENT_CONNECTED);

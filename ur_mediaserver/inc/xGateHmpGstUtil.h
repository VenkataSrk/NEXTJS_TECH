...
typedef enum
{
  ...
  EN_PIPELINE_CONFERENCE_AUDIO,
	EN_PIPELINE_RECORD_AUDIO_VIDEO,
	EN_PIPELINE_MIX_AUDIO_VIDEO,
	EN_PIPELINE_VIDEO_DECODE,
  EN_PIPELINE_RECORD_AUDIO_RECV,
  EN_PIPELINE_RECORD_VIDEO_RECV,
  EN_PIPELINE_VIDEO_COMPOSITOR,
  EN_PIPELINE_RECORD_AUDIO_VIDEO_MUX,
} HmpChannelType;
...
typedef enum
{
  ...
  EN_BIN_RECORD_AUDIO_VIDEO,
  EN_BIN_MIX_AUDIO_VIDEO,
  EN_BIN_VIDEO_DECODE,
  EN_BIN_VIDEO_VP8,
} HmpBinType;
...
struct ClientDetail {
  ...
  int m_legId;
  unsigned int m_retrieved_videossrc;
  unsigned int m_retrieved_audiossrc;
  int m_context_id;
  int m_isCcaas;
  int m_domain_id;
  int m_agent_id;
  long int m_recStartTime;
  long int m_recEndTime;
  ...
  unsigned int m_pbxPort;
	...
	string m_sip_id;
	string m_customer_num;
  string m_rec_fileSize;
  ...
  ClientDetail() : 
    ...
    m_context_id(0), m_isCcaas(0), m_domain_id(0), m_agent_id(0), m_recStartTime(0), m_recEndTime(0), m_mediaModeIn(EN_MEDIA_UNKNOWN), m_mediaModeOut(EN_MEDIA_UNKNOWN),m_screenshare_id(""), m_dtmfBuffer(""),
    m_mediaEvent(EN_MEDIA_EVENT_NULL), m_joinerType(EN_JOINER_TYPE_UNKNOWN), m_callDir(EN_CALL_DIR_UNKNOWN),
    m_sigType(3), m_rtpEp(""), m_filePath(""), m_fileSize(0), m_pbxIp(""), m_pbxPort(0),m_sdpStr(""),m_record_file(""),m_browser_type(""),m_record_url(""), m_record_id(""), m_meeting_name(""),m_sip_id(""),m_customer_num(""),m_file_duration(""),m_rec_fileSize(""),m_retrieved_audiossrc(0),m_retrieved_videossrc(0)
  {};
  ...
  ClientDetail& operator=(ClientDetail &src)
  {
    ...
    m_legId = src.m_legId;
    m_retrieved_audiossrc = src.m_retrieved_audiossrc;
    m_retrieved_videossrc = src.m_retrieved_videossrc;
    m_context_id = src.m_context_id;
    m_isCcaas = src.m_isCcaas;
    m_domain_id = src.m_domain_id;
    ...
    m_fileSize = src.m_fileSize;
		m_rec_fileSize = src.m_rec_fileSize;
		m_file_duration = src.m_file_duration;
    m_pbxIp = src.m_pbxIp;
    ...
    m_customer_num = src.m_customer_num;
    return *this;
  };
};

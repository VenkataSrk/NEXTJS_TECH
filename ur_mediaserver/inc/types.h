...
//#include <sqltypes.h> //Yoga disabled compile error on centos 8
...
//#include "siptypes.h" //must include this for sake of IString,List, String,Vector
...
typedef struct _PERF_COUNTER_DEFINITION {
  ...
  _LPWSTR CounterNameTitle;
  DWORD  CounterHelpTitleIndex;
  _LPWSTR CounterHelpTitle;
  DWORD   DefaultScale;
  DWORD  DetailLevel;
  DWORD  CounterType;
  DWORD  CounterSize;
...
typedef struct _PERF_OBJECT_TYPE {
  ...
  _LPWSTR        ObjectNameTitle;
  DWORD         ObjectHelpTitleIndex;
  _LPWSTR        ObjectHelpTitle;
  DWORD         DetailLevel;
  DWORD         NumCounters;

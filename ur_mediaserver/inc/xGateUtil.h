...
#define REC_CONNECT_PORT 32778

#define TCP_CONNECTOR_TIME_OUT_MS 100
#define TCP_RE_CONNECTOR_TIME_OUT_MS 1000
...
typedef enum
{
  ...
  EN_XGATE_MG_VIDEO_REC_REQ = 28,
  EN_XGATE_MG_VIDEO_REC_RES = 29,
  ...
  EN_XGATE_MG_VIDEO_KEY_FRAME_REQUEST_FROM_REC_SERVER = 36,
}xGateMgMsgType;
...
typedef enum
{
  EN_JOINER_TYPE_UNKNOWN = 0,
  EN_JOINER_TYPE_HOST = 1,
  EN_JOINER_TYPE_PARTICIPANT = 2,
  EN_JOINER_TYPE_GUEST = 3,
  EN_JOINER_TYPE_SCREENSHARE = 4
} xGateJoinerType;
...
typedef enum {
  EN_XGATE_ASR_TYPE_UNKNOWN,
  EN_XGATE_ASR_INHOUSE,
}xGateHmpClientAsrType;
...
struct MgMediaDetail
{
  ...
  uint64_t pClient;
  xGateHmpClientAsrType asr_type;
  ...
  MgMediaDetail()
  {
    ...
    retrieved_audiossrc = 0;
    retrieved_videossrc = 0;
    asr_type=EN_XGATE_ASR_TYPE_UNKNOWN;
    is_ccaas = 0;
    prev_act_spkr = "";
  };

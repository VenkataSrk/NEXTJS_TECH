...
#define MEDIAUTIL MediaUtil::instance()
class MediaServiceUtil : public ACE_Task<ACE_MT_SYNCH> {
  public:
    MediaServiceUtil();
    ~MediaServiceUtil(void);
...
typedef ACE_Unmanaged_Singleton<MediaServiceUtil, ACE_Null_Mutex> MediaUtil;
#endif

...
class xGateMgMsg : public xGateBaseMsg {
 ...
 public:
    ...
    MgPlayBackDetail & get_playback_detail() {
      return m_playback_detail;
    }
    ...
    void set_playback_detail(MgPlayBackDetail & playback_detail) {
      m_playback_detail = playback_detail;
    }
  ...
  private:
    ...
    MgPlayBackDetail m_playback_detail;
    //CTask *m_pTask;
};

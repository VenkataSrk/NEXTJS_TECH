...
xGateTCPReceiver::xGateTCPReceiver (const char*serverType, ACE_Task<ACE_MT_SYNCH>* taskPtr):
  ...
  m_taskPtr(taskPtr)
{
  XGLOG_WARN( "xGateTCPReceiver::xGateTCPReceiver(%s)", serverType);
...
{
  XGLOG_WARN( "xGateTCPReceiver::init(%s)", m_serverType);
...
{
  XGLOG_WARN( "xGateTCPReceiver::~xGateTCPReceiver(%s) destructor called", m_serverType);
...
{
  XGLOG_WARN( "xGateTCPReceiver::stopThread(%s) called", m_serverType);
  ...
  XGLOG_WARN( "xGateTCPReceiver::stopThread(%s) Stopped xGateTCPReceiver", m_serverType);
  return EN_XGATE_STATUS_SUCCESS;
}

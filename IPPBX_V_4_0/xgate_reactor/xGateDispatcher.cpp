  ...
  m_run(false)
{
  ...
  XGLOG_WARN( "xGateDispatcher::xGateDispatcher(%s)", m_serverType);
}
...
{
  XGLOG_WARN( "xGateDispatcher::stop(%s)", m_serverType);
  ...
  XGLOG_WARN( "xGateDispatcher::stop Stopped xGateDispatcher(%s)", m_serverType);
...
{
  XGLOG_WARN( "xGateDispatcher::init(%s)", m_serverType);
  m_run = true;
  ...
  {
    // Successfull start
    XGLOG_WARN( "xGateDispatcher::init(%s) Success", m_serverType);
  }
  return retVal;
}
...
{
  XGLOG_WARN( "xGateDispatcher::svc(%s)", m_serverType);
  ...
  while(m_run)
  {
    ...
    else
    {
      ...
      XGLOG_ERROR("xGateDispatcher::svc(%s) Error in Message Queue", m_serverType);
      m_run = false;
    }
...
{
  XGLOG_WARN( "xGateDispatcher::dispatchMessage(%s)", m_serverType);
  return EN_XGATE_STATUS_SUCCESS;
}

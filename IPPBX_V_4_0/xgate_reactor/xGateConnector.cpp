  ...
  m_connectTimeOut(3)
{
  ...
  XGLOG_INFO( "Connector::xGateConnector(%s)"\
...
{
  XGLOG_INFO( " xGateConnector::connectToPeer"); 
  XGLOG_INFO( " xGateConnector::connectToPeer");
  return EN_XGATE_STATUS_SUCCESS; 
}
...
xGateRetVal xGateConnector::stopThread( void )
{
  ...
  XGLOG_INFO( "Connector::stopThread(%s) Stopped xGateConnector", m_serverType);
  return EN_XGATE_STATUS_SUCCESS;
} 
...
{
   XGLOG_INFO( " xGateConnector::addFdToSocketHandlerMap");
...
{
   XGLOG_INFO( " xGateConnector::getHandlerFromFdToSocketHandlerMap");
...
{
   XGLOG_INFO( " xGateConnector::removeFromFdToSocketHandlerMap");

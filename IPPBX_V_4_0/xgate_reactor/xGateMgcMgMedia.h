/*-------------------------------------------------------------------------------*
 * $Archive: /xgate_reactor/xGateMgcMgMedia.h $
 *
 * Description:
 * This module contains media details, that will be shared between MGC-MG servers
 *------------------------------------------------------------------------------*/

#ifndef _XGATE_MGC_MG_MEDIA_H
#define _XGATE_MGC_MG_MEDIA_H
...
public :
  ...
  {
    //return RTP_Board_Host; //TODO: Yoga got compiler error, its not recongnize RTP_Board_Host. so return hardcoded value
    return 5; 

			   ...
			   nua_handle_preferences_t *nhp)
{
  ...
  NHP_SET(nhp, media_enable, 0);
  NHP_SET(nhp, accept_multipart, 1);
...
////  nhp->nhp_session_timer = 1800; // commented by IPPBX
  nhp->nhp_refresher = nua_no_refresher;

  //NHP_SET(nhp, min_se, 120);
////  NHP_SET(nhp, min_se, 1800);  // commented by IPPBX
...
/////  NHP_SET(nhp, supported, sip_supported_make(home, "timer, 100rel")); // commented by IPPBX

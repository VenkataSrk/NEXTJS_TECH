export const agentInstagramInboundMetricsFilterScheme = {
  body: {
    type: 'object',
    properties: {
...
export const agentInstagramPerformanceMetricsFilterScheme = {
  body: {
    type: 'object',
    properties: {
      startTimeStamp: { type: ['number', 'null'] },
...
export const  agentInstagramServicelevelMetricsFilterScheme = {
  body: {
    type: 'object',
    properties: {
      startTimeStamp: { type: ['number', 'null'] },

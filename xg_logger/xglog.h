 ...
 * Example:
 *
 *  XGLOG_INFO( "HmpBin::~HmpBin start for bin: %s", (char*)ur_log_string (m_binName));// m_binName is a string
 *
 *   XGLOG_INFO( "HmpBin::~HmpBin start for bin: %s", (char*)ur_log_string (lpszVal));// lpszVal is a char *
 *
 *
 *   */
...
//class for entry exit function log

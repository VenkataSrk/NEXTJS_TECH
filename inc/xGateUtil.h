...
typedef enum
{
  ...
  EN_XGATE_MG_GRID_VIEW_VIDEO_REQUEST = 35,
...
class MgMediaDetail
{
  public:
    ...
    MgMediaDetail() 
      ...
      conn_id(""), device_id(""), prev_act_spkr(""), meeting_name(""), sip_id(""), call_dir(0), sig_type(3), 
			sdp_str(""), org_rtp_ep(""), dst_rtp_ep("") {};
    ...
    MgMediaDetail& operator=(MgMediaDetail &src)
    {
      ...
      prev_act_spkr = src.prev_act_spkr;
